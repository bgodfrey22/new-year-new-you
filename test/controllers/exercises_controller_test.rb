...
class ExercisesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create exercise" do
    assert_difference('Exercise.count') do
      post exercises_url, params: { exercise: { muscle_group: @exercise.muscle_group, name: @exercise.name } }
    end
  ...
  test "should update exercise" do
    patch exercise_url(@exercise), params: { exercise: { muscle_group: @exercise.muscle_group, name: @exercise.name } }
